                ...
                <tr style={columnCommandSytle}>
                    {this.props.columns
                        ...
                        .map(col => {
                            ...
                            if (style !== undefined) {
                                return (
                                    <td className={'table-col'} data-id={col.id} style={{
                                        ...columnCommandSytle,
                                        ...{
                                ...
                                return (
                                    <td className={'table-col'} data-id={col.id} style={{...columnCommandSytle, width: (col.width === '0' ? 'auto' : col.width) }}>{col.value}</td>
                                )
                            }
                        })}
                </tr>,
                        ...
                        <tr style={headerStyle}>
                            {this.props.columns
                                ...
                                .map(col => {
                                    ...
                                    if (style !== undefined) {
                                        return (
                                            <th data-id={col.id} className={'table-col'} style={{
                                                ...headerStyle,
                                                ...{
                                                    width: (col.width === '0' ? 'auto' : col.width),
                                                    textAlign: style.align,
                                        ...
                                        return (
                                            <th data-id={col.id} className={'table-col'} style={{...headerStyle,width: (col.width === '0' ? 'auto' : col.width) }}>{col.title}</th>
                                        )
                                    }
                                })}
                        </tr>
...
export default connect(mapStateToProps,{changeColumn})(Table);
