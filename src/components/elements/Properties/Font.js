            ...
            <div className="col-6 text-right">
              <div className="btn-group d-flex btn-group-sm">
                <button
                  type="button"
                  onClick={() => {
                    this.handleMe({ bold: !this.state.bold });
                  }}
                  className={`btn w-100 ${
                    this.props.activeElement.properties.font.bold
                      ? "btn-primary"
                      : ""
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    this.handleMe({ italic: !this.state.italic });
                  }}
                  className={`btn w-100 ${
                    this.props.activeElement.properties.font.italic
                      ? "btn-primary"
                      : ""
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    this.handleMe({ underline: !this.state.underline });
                  }}
                  className={`btn w-100 ${
                    this.props.activeElement.properties.font.underline
                      ? "btn-primary"
                      : ""
                  }`}
                >
